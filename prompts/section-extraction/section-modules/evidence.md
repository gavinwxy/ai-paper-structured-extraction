...
- Do not create method Contribution or Component units here; reference those nodes by id in `about` edges (they are materialized in the method section). A dataset/benchmark or `finding`-kind Contribution, however, IS materialized here.

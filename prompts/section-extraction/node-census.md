...
> **Provenance.** Production node-census prompt (section-ir-0.17), written in the persona-driven,
> definition-first SC idiom. The pre-SC original is archived at
> `archive/legacy-prompts/section-ir-0.17-original/section-extraction/node-census.md` — an intended
> semantic equivalent (same types, kinds, id-prefixes, exclusions, and procedure); this set is
> authoritative.
>
